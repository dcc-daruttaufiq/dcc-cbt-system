        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">
              Semangat belajar dan disiplin santri, terlihat dari progres nyata.
            </p>
          </div>
        </div>
        ...
        <div className="bg-[#0d1527]/70 border border-slate-800 rounded-2xl overflow-hidden">
          {loading ? (
            ...
            <p className="px-5 py-6 text-xs text-slate-500">
              Belum ada data poin. Insert manual 1 baris ke tabel{" "}
              <code className="text-cyan-400">poin_santri</code> untuk uji coba,
              misalnya tech_id, sumber = 'presensi', jumlah_poin = 5.
            </p>
          ) : (
            leaderboard.map((row, idx) => (
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-8 flex justify-center">
                    {idx < 3 ? (
                      ...
                      <span className="font-['Rajdhani',sans-serif] text-slate-500 font-bold">
                        {idx + 1}
                      </span>
                    )}
                  </div>
                ...
                <div className="flex items-center gap-1.5 shrink-0">
                  ...
                  <span className="font-['Rajdhani',sans-serif] font-bold text-lg text-white">
                    {row.total_poin}
                  </span>
                </div>
              </motion.div>
